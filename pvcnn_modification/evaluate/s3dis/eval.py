...
def evaluate(configs=None):
    ...
    for scene_index, (scene, scene_files) in enumerate(tqdm(dataset.scene_list.items(), desc='eval', ncols=0)):
        ...
        total_num_points_in_scene = sum(1 for line in open('datasets/S3DIS/Area_5/office_1/office_1.txt'))
        #total_num_points_in_scene = 760563
        ...
        np.save(configs.evaluate.stats_path + ".predictions." + str(scene_index), predictions)
